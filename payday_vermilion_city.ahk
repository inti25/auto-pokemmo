...
myGui.SetFont("cWhite")
ogcTextLocation := myGui.Add("Text", "vLocation x36 y180 w85 h20 +BackgroundTrans +Center", "Vermilion City")
...
Quit() {
    ...
    if (!DetectBattle()) {
        ...
        if (botState.battleCount >= botState.maxBattlesBeforeHeal || detect_pp() || detect_hp() || detect_cannot_fish()) {
            Heal()
        }
    } else {
